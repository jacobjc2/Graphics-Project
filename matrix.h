...
class matrix
{
	public:
		...
		// Cross product - perform the cross product between two
		// 3x1 matrices, or "vectors"
		//
		// throw (matrixException)
		//
		static matrix crossProduct(matrix a, matrix b);

		// Vector angle - finds the angle between 2 3x1 vectors
		//
		// throw (matrixException)
		//
		static double vectorAngle(const matrix a, const matrix b);
